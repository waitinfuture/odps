...
-   推荐您使用[MaxCompute Studio工具](../../../../cn.zh-CN/工具及下载/MaxCompute Studio/认识Studio.md#)进行完整的大数据开发流程。该工具集成Java环境，可进行MaxCompute SQL脚本开发/执行、数据管理、可视化分析日志、Java（[UDF](../../../../cn.zh-CN/用户指南/SQL/UDF/UDF概述.md#)、[MR](../../../../cn.zh-CN/用户指南/MapReduce/Java SDK/原生SDK概述.md#)）开发。客户端（odpscmd）目前也已集成该工具中。
