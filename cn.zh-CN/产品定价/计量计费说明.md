...
2019年2月1日起，MaxCompute [Lightning服务](../../../../../cn.zh-CN/用户指南/Lightning/Lightning概述.md#)开始计费。

Lightning（交互式分析）任务按量后付费：您每开展一次Lightning查询作业，MaxCompute将根据该作业的**输入数据**进行计费。该费用在SQL执行完成后产生，并在下一天做一次性的计费结算。
