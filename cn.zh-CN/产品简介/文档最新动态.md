...
|2019.04.26|新增项目空间生命周期操作命令说明；新增IP白名单支持的IPV6格式|新规格|项目空间操作中增加生命周期操作命令说明。IP白名单已支持IPV6格式。|所有|[项目空间操作](../../../../cn.zh-CN/用户指南/常用命令/项目空间操作.md#)|
|2019.04.19|新增Windows环境下编译Spark的步骤|新规格|新增Windows环境下编译Spark的步骤。|所有|[Windows环境下编译Spark](../../../../cn.zh-CN/用户指南/Spark/快速开始/编译Spark并添加依赖.md#section_j0i_dqd_rxo)|
|2019.04.18|新增脚本模式SQL|新规格|MaxCompute当前的SQL引擎已支持脚本模式。|所有|[脚本模式SQL](../../../../cn.zh-CN/用户指南/SQL/脚本模式SQL.md#)|
...
|2019.04.15|新增开启数据保护机制后的数据流出方法|新规格|可以通过设置Exception Policy开启数据保护机制后的数据流出方法。|所有|[项目空间的数据保护](../../../../cn.zh-CN/安全指南/安全功能详解/项目空间的数据保护.md#)|
|2019.04.11|新增InstanceTunnel介绍及示例|新规格|可以通过InstanceTunnel下载以select关键字开头的用于获取数据的SQL Instance。|所有|[InstanceTunnel](../../../../cn.zh-CN/用户指南/数据上传下载/批量数据通道SDK介绍/InstanceTunnel.md#)、[简单下载示例](../../../../cn.zh-CN/用户指南/数据上传下载/批量数据通道SDK示例/简单下载示例.md#)|
